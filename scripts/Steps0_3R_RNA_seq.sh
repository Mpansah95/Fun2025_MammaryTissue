...
MyID=aubclsd0321          ## Example: MyID=aubtss


WD=/scratch/mammary/StandardPipeline            ## Example:/scratch/$MyID/PracticeRNAseq  
DD=$WD/RawData
RDQ=RawDataQuality
...
REFD=$WD/BoxerRefGenome          ## Example:/scratch/$MyID/PracticeRNAseq/DaphniaRefGenome    # this directory contains the indexed reference genome for the garter snake
...
RESULTSD=/home/$MyID/FinalPipeline03/Counts_H_S_2024      ## Example:/home/aubtss/PracticeRNAseq/Counts_H_S
...
fasterq-dump SRR7819906
fasterq-dump SRR7780898
fasterq-dump SRR22458547
fasterq-dump SRR22458540
fasterq-dump SRR7819798
fasterq-dump SRR7780828

fasterq-dump SRR7819901
fasterq-dump SRR7819938
fasterq-dump SRR7819835
fasterq-dump SRR7819862
fasterq-dump SRR7819748
fasterq-dump SRR7819792
